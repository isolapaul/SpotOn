export const translations = {
  hu: {
    ...
    useCustomIcons: 'Egyedi ikonok használata',
    customizeNameStyle: 'Név színének és betűtípusának testreszabása',
  ...
  en: {
    ...
    useCustomIcons: 'Use custom icons',
    customizeNameStyle: 'Customize name color and font',
  ...
  de: {
    ...
    useCustomIcons: 'Benutzerdefinierte Symbole verwenden',
    customizeNameStyle: 'Name Farbe und Schriftart anpassen',
