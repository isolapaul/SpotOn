export const translations = {
  hu: {
    ...
    // AuthModal (T24)
    authWelcome: 'Üdvözöl a SpotOn',
    authWelcomeDesc: 'Jelentkezz be vagy regisztrálj a kedvenc helyeid mentéséhez',
    authSignIn: 'Bejelentkezés',
    authSignUp: 'Regisztráció',
    authSignInDesc: 'Jelentkezz be az email címeddel',
    authSignUpDesc: 'Hozz létre új fiókot',
    authSigningIn: 'Bejelentkezés...',
    authGoogle: 'Google',
    authOr: 'vagy',
    authWithEmail: 'Email címmel',
    authUsername: 'Felhasználónév',
    authEmail: 'Email',
    authPassword: 'Jelszó',
    authUsernamePlaceholder: 'felhasználóneved',
    authEmailPlaceholder: 'email@pelda.com',
    authPasswordPlaceholder: '••••••••',
    authPasswordHint: 'Legalább 6 karakter',
    authNoAccount: 'Még nincs fiókod? Regisztrálj',
    authHaveAccount: 'Van már fiókod? Jelentkezz be',
    authBack: '← Vissza',
    authTerms: 'A bejelentkezéssel elfogadod az Általános Szerződési Feltételeket és az Adatvédelmi Szabályzatot',
    authErrGoogle: 'Google bejelentkezés sikertelen. Próbáld újra.',
    authErrUsername: 'Add meg a felhasználónevedet!',
    authErrInvalidEmail: 'Érvénytelen email cím.',
    authErrWrongPassword: 'Hibás email vagy jelszó.',
    authErrEmailInUse: 'Ez az email cím már használatban van.',
    authErrWeakPassword: 'A jelszónak legalább 6 karakter hosszúnak kell lennie.',
    authErrInvalidCredential: 'Hibás bejelentkezési adatok.',
    authErrSignInFailed: 'Bejelentkezés sikertelen.',
  ...
  en: {
    ...
    // AuthModal (T24)
    authWelcome: 'Welcome to SpotOn',
    authWelcomeDesc: 'Sign in or register to save your favorite spots',
    authSignIn: 'Sign In',
    authSignUp: 'Sign Up',
    authSignInDesc: 'Sign in with your email',
    authSignUpDesc: 'Create a new account',
    authSigningIn: 'Signing in...',
    authGoogle: 'Google',
    authOr: 'or',
    authWithEmail: 'With Email',
    authUsername: 'Username',
    authEmail: 'Email',
    authPassword: 'Password',
    authUsernamePlaceholder: 'yourusername',
    ...
    authBack: '← Back',
    authTerms: 'By signing in, you agree to our Terms of Service and Privacy Policy',
    authErrGoogle: 'Google sign in failed. Please try again.',
    authErrUsername: 'Please enter your username!',
    authErrInvalidEmail: 'Invalid email address.',
    authErrWrongPassword: 'Wrong email or password.',
    authErrEmailInUse: 'This email address is already in use.',
    authErrWeakPassword: 'Password must be at least 6 characters long.',
    authErrInvalidCredential: 'Invalid credentials.',
    authErrSignInFailed: 'Sign in failed.',
  ...
  de: {
    ...
    // AuthModal (T24)
    authWelcome: 'Willkommen bei SpotOn',
    authWelcomeDesc: 'Melde dich an oder registriere dich, um deine Lieblingsorte zu speichern',
    authSignIn: 'Anmelden',
    authSignUp: 'Registrieren',
    authSignInDesc: 'Melde dich mit deiner E-Mail an',
    authSignUpDesc: 'Erstelle ein neues Konto',
    authSigningIn: 'Anmeldung...',
    authGoogle: 'Google',
    authOr: 'oder',
    authWithEmail: 'Mit E-Mail',
    ...
    authBack: '← Zurück',
    authTerms: 'Mit der Anmeldung akzeptierst du die Allgemeinen Geschäftsbedingungen und die Datenschutzerklärung',
    authErrGoogle: 'Google-Anmeldung fehlgeschlagen. Bitte versuche es erneut.',
    authErrUsername: 'Bitte gib deinen Benutzernamen ein!',
    authErrInvalidEmail: 'Ungültige E-Mail-Adresse.',
    authErrWrongPassword: 'Falsche E-Mail oder Passwort.',
    authErrEmailInUse: 'Diese E-Mail-Adresse wird bereits verwendet.',
    authErrWeakPassword: 'Das Passwort muss mindestens 6 Zeichen lang sein.',
    authErrInvalidCredential: 'Ungültige Anmeldedaten.',
    authErrSignInFailed: 'Anmeldung fehlgeschlagen.',
